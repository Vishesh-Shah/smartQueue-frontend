...
const AdminSignup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(error.response?.data?.message || 'Admin signup failed');
    }
    setLoading(false);
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 flex items-center justify-center p-4">
      ...
      >
        ...
        >
          ...
          <p className="text-gray-300">Set up your business admin credentials</p>
        </motion.div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            ...
            <p className="text-gray-300 text-sm">
              You can only create an admin account if your business email has been approved by the system administrator.
            </p>
          </motion.div>
        ...
        >
          <p className="text-gray-300">
            ...
            <Link to="/admin" className="text-green-400 hover:text-green-300 font-semibold transition-colors">
              Sign in
            </Link>
          </p>
          <p className="text-gray-300">
            Need approval?{' '}
            <Link to="/request-admin-access" className="text-blue-400 hover:text-blue-300 font-semibold transition-colors">
              Request Access
            </Link>
          </p>
